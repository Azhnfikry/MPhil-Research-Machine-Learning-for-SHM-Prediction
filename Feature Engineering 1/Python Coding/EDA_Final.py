...
# CONFIG
# ─────────────────────────────────────────────
_BASE = Path(r"C:\Users\N O\Desktop\MASTER\Methodology & Result\Final Dataset to use")
ENGINEERED_FILE = _BASE / "Final_30min_Combined_Dataset.csv"  # input CSV with engineered features
